document.addEventListener('DOMContentLoaded', () => {
    ...
    initCanvas(); window.addEventListener('resize', initCanvas); drawGrid();
    ...
    function updateClocks() {
        ...
        zones.forEach(zone => {
            ...
            if (el) {
                const options = { hour12: false, hour: '2-digit', minute: '2-digit', timeZone: zone.tz };
    ...
    capsule.addEventListener('scroll', () => {
        ...
        // 6A. Word Scrubbing FIX (Ensures first word resets)
        ...
        if (scrollY >= startScrub && scrollY <= endScrub) {
            ...
            // Critical Fix: Progress forced to -1 index if at start
